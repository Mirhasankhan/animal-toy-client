...
const Footer = () => {
    return (
        <div className='bg-gray-400'>
            <div className='grid grid-cols-2 md:grid-cols-3 gap-6 py-5 mx-3 md:mx-16'>
                ...
                <div className=' w-full'>
                    <h1 className='pb-2 md:pb-12 text-xl font-bold italic'>Contact Info</h1>
                ...
                <div className=' w-full'>
                    <h1 className='pb-2 md:pb-12 text-xl font-bold italic'>Our Social Media Links</h1>
