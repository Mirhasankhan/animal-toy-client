        ...
        <div className='bg-[#111723]'>
            <div className='grid grid-cols-3 gap-6 py-5 mx-3 lg:mx-16'>
                <div>
                    ...
                    <h1 className='text-white text-xl font-bold'>Toy Emporium</h1>
                ...
                <div className='text-white'>
                    <h1 className='pb-12 text-xl font-bold'>CONTACT INFO</h1>
                    <div className='footer-number'>
                        <FaPhone className='text-blue-600 mr-2'></FaPhone>
                        <p>00+11482145854</p>
                    </div>                    
                    <div className='footer-number mt-4'>
                        <FaEnvelope className='mr-2 text-orange-300'></FaEnvelope>
                        <p>toy0144s@gmail.com</p>
                    </div>                    
                </div>
                <div className='text-white'>
                    <h1 className='pb-12 text-xl font-bold'>Our Social Media Links</h1>
                    <div className="flex gap-3">
                        <a href="https://www.facebook.com/">
                            <FaFacebook className='text-4xl text-blue-600'></FaFacebook>
                        </a>
                        <a href="https://www.instagram.com/">
                            <FaInstagram className='text-4xl text-purple-800'></FaInstagram>
                        </a>
